...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   appended_file_adding.c                             :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: aronez <aronez@student.42.fr>              +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/12/20 17:28:29 by aronez            #+#    #+#             */
/*   Updated: 2022/12/20 17:28:29 by aronez           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
		...
		)
{
	...
	*idx = skip_spaces(command_sections, *idx);
	...
	if (file_name.data == NULL)
		return (ft_fdprintf(2, "Parsing error : file name missing\n"), -1);
	append_file(command_allocator, (t_file){APPEND, fds[0], file_name.data});
	if (fds[1] >= 0)
		append_file(command_allocator, (t_file){APPEND, fds[1],
